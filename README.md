...
```bash
curl -fLO https://github.com/tsouth89/omakade/releases/download/v1.2.2/omakade-1.2.2-1-x86_64.pkg.tar.zst
curl -fLO https://github.com/tsouth89/omakade/releases/download/v1.2.2/SHA256SUMS
sha256sum -c SHA256SUMS --ignore-missing
sudo pacman -U ./omakade-1.2.2-1-x86_64.pkg.tar.zst
```

### Install or upgrade from a browser download

1. Open the [latest release](https://github.com/tsouth89/omakade/releases/latest).
2. Under **Assets**, download `omakade-1.2.2-1-x86_64.pkg.tar.zst` and
