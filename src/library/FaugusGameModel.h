...
class FaugusGameModel final : public QAbstractListModel {
  Q_OBJECT
  Q_PROPERTY(bool faugusDetected READ faugusDetected NOTIFY statusChanged)
...
public:
  ...
  [[nodiscard]] bool faugusDetected() const;
...
private:
  ...
  void applyScan(const FaugusScanResult& result);
